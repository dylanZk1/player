...
public final class ControlWrapper {
    ...
    public void danmuControl(String tag, Object ...extra){
        if(null != mController){
            mController.danmuControl(tag,extra);
        }
    }

    public boolean danmuClick(IDanmakus danmakus){
        if(null != mController){
            mController.danmuClick(danmakus);
        }
    ...
    public boolean danmuLongClick(IDanmakus danmakus){
        if(null != mController){
            mController.danmuLongClick(danmakus);
        }
    ...
    public void updateTimer(DanmakuTimer timer){
        if(null != mController){
            mController.updateTimer(timer);
        }
    }

    public void danmuStart(long duration){
        mController.danmuStart(duration);
    }
