package com.android.iplayer.base.controller;
...
public abstract class BaseController extends FrameLayout implements IVideoController {
     ...
     * @param playerControl
     */
    public void attachedPlayer(IPlayerControl playerControl) {
    ...
    public void addControllerWidget(IControllerView... iControllerViews) {
        ...
        if(null!=iControllerViews&&iControllerViews.length>0){
            ...
            for(int i = 0; i < iControllerViews.length; i++){
                addControllerWidget(iControllerViews[i]);
//                if(iControllerViews[i] instanceof IDanmuControl){
//                    addControllerWidget(iControllerViews[i],0);
//                }else{
//                    addControllerWidget(iControllerViews[i],-1);
//                }
            }
//            for (IControllerView iControllerView : iControllerViews) {
//                if(iControllerView instanceof IDanmuControl){
//                    addControllerWidget(iControllerView,0);
//                }else{
...
//    public void getlayoutframe(IControllerView controllerView){
//        controllerView.getView().getParent().;
//    }
    /**
     * 设置给用户看的虚拟的视频总时长
