package com.android.iplayer.base.interfaces;
...
public interface IVideoController {
    ...
    /**
     * 兼容弹幕层和其他控制层之间的Touch事件
     * @param tag
     * @param extra
     */
    default void danmuControl(String tag, Object ...extra){

    }

    default void danmuStart(long duration){

    }

    default boolean danmuClick(IDanmakus danmakus){
        return false;
    }

    default boolean danmuLongClick(IDanmakus danmakus){
        return false;
    }
