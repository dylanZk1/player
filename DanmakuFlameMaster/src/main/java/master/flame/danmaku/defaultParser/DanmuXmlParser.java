package master.flame.danmaku.defaultParser;
...
public class DanmuXmlParser extends BaseDanmakuParser {
    ...
    public class XmlContentHandler extends DefaultHandler {
        ...
        public void characters(char[] ch, int start, int length) {
            if (item != null) {
                DanmakuUtils.fillText(item, StringEscapeUtils.unescapeXml(new String(ch, start, length)));
                item.index = index++;
