package com.android.iplayer.player.media;
...
import com.android.iplayer.base.listener.OnMediaEventListener;
import com.android.iplayer.base.manager.IVideoManager;
import com.android.iplayer.player.media.core.MediaPlayerFactory;
import com.android.iplayer.base.model.PlayerState;
import com.android.iplayer.player.utils.AudioFocus;
import com.android.iplayer.base.utils.ILogger;
import com.android.iplayer.base.utils.PlayerUtils;
import com.android.iplayer.player.utils.ThreadPool;
...
//        ILogger.d(TAG,"onInfo-->what:"+what+",extra:"+extra);
    ...
    private boolean islocate(Object dataSource){
        if(dataSource!=null){
            if(dataSource instanceof String && !TextUtils.isEmpty((String)dataSource)){
                Uri tmp = Uri.parse(String.valueOf(dataSource));
                if(tmp.getScheme().equals("android.resource") || tmp.getScheme().equals("file") || tmp.getScheme().equals("content")){
                    return true;
                }
