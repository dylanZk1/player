...
public class VideoPlayer extends BasePlayer {
    ...
    @Override
    public void onQuitFullScreen(boolean isLocal, ViewGroup viewGroup) {
        if(isLocal){
            setOrientation(getmScreenOrientation());
        }
    }

    @Override
    public void onQuitWindow(boolean isLocal, ViewGroup viewGroup) {
        onDestroy();
    }
    ...
    public void setIsOutLink(Boolean isOutLink1, Boolean isLocal){
        this.isOutLink = isOutLink1;
