...
public class SubtitleUtil {
    ...
    public static SubtitleFileReader getSubtitleFileReader(File file) {
        return getSubtitleFileReaderByName(file.getName());
    }
     ...
     * @return
     */
    public static SubtitleFileReader getSubtitleFileReaderByName(String fileName) {
        String ext = FileUtil.getFileExt(fileName);
        return getSubtitleFileReaderByExt(ext);
    }

    public static SubtitleFileReader getSubtitleFileReaderByExt(String ext){
        for (SubtitleFileReader subtitleFileReader : readers) {
