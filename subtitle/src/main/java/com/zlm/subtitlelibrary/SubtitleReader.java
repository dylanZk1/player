...
public class SubtitleReader {
    ...
    public void readInputStream(InputStream zimu, String ext) throws Exception{
        SubtitleFileReader subtitleFileReader = SubtitleUtil.getSubtitleFileReaderByExt(ext);
        subtitleInfo = subtitleFileReader.readInputStream(zimu);
    }
