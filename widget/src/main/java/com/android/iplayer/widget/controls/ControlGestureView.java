...
public class ControlGestureView extends BaseControlWidget implements IGestureControl {
    ...
    public void initViews() {
        ...
        mPresentIcon = findViewById(R.id.gesture_present_icon);
        mPresentText = findViewById(R.id.gesture_present_text);
        mPresentProgress = findViewById(R.id.gesture_present_progress);
    }
