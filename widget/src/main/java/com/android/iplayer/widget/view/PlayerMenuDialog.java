...
//        R.style.MenuButtomAnimationStyle
        setContentView(R.layout.dialog_menu);
        initLayoutPrams(context);
...
//    public PlayerMenuDialog(ContextThemeWrapper wrapper){
//        super(wrapper);
//        setContentView(R.layout.dialog_menu);
//        initLayoutPrams(wrapper.getApplicationContext());
//        findViewById(R.id.dialog_close).setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                PlayerMenuDialog.this.dismiss();
...
//    }
    ...
    protected void initLayoutPrams(Context context){
