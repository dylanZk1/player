...
public class PagerPlayerFragment extends BaseFragment {
    ...
    protected void initViews() {
        findViewById(R.id.ll_bar_margin).getLayoutParams().height= ScreenUtils.getInstance(App.getInstance().getContext()).getStatusBarHeight(getContext())+ScreenUtils.getInstance(App.getInstance().getContext()).dpToPxInt(49f);
        //视频列表适配器准备
