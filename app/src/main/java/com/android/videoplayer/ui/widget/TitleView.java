...
public class TitleView extends FrameLayout {
    ...
    public TitleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        titleBg.getLayoutParams().height=PlayerUtils.getInstance().getNavigationHeight(getContext())+ ScreenUtils.getInstance(App.getInstance().getContext()).dpToPxInt(49f);
        if(0==mTitleStyle){
