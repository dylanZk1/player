...
public class VideosPlayerActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CorePlayerView corePlayerView=new CorePlayerView(mPlayerContainer.getContext(),this);
        ...
        findViewById(R.id.add_player).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CorePlayerView corePlayerView=new CorePlayerView(mPlayerContainer.getContext(),VideosPlayerActivity.this);
                //每次布局发生了变化都自动滚动到底部
