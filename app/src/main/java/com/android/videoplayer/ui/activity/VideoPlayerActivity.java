...
public class VideoPlayerActivity extends BaseActivity {
    ...
    private void initPlayer() {
        ...
        ControlWindowView windowView=new ControlWindowView(this);//悬浮窗窗口播放器的窗口样式
        mDanmuWidgetView = new DanmuWidget(mController.getContext(), new OriginalResource() {
            @Override
        ...
        mController.addControllerWidget(mDanmuWidgetView,0);
