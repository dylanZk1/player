...
public class DanMuActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitiy_bilibili_danmu);
        findViews();
    }
    ...
    private BaseDanmakuParser createParser(InputStream stream) {
        ...
        BaseDanmakuParser parser = new DanmuXmlParser();
    ...
    private void findViews() {
        ...
        mContext.setDanmakuStyle(IDisplayer.DANMAKU_STYLE_STROKEN, 3).setDuplicateMergingEnabled(false).setScrollSpeedFactor(1.2f).setScaleTextSize(1.0f)
                .setCacheStuffer(new SpannedCacheStuffer(), mCacheStufferAdapter)// 图文混排使用SpannedCacheStuffer
//        .setCacheStuffer(new BackgroundCacheStuffer())  // 绘制背景使用BackgroundCacheStuffer
                .setMaximumLines(maxLinesPair)
                .preventOverlapping(overlappingEnablePair).setDanmakuMargin(40)
                .setTypeface(this, "default");
        if (mDanmakuView != null) {
